...
\item extraction of the block views, depending on 3 Cartesian indices, from image arrays;

\item transform  each job \emph{from global} $[\ell_1]\times[\ell_2]\times[\ell_3]$ to \emph{local coordinates} $[n]\times[n]\times[n]$;
